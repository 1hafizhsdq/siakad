            ...
            <form id="form">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <input id="nama_prodi" name="nama_prodi" type="text" placeholder="Nama Program Studi" class="form-control">
                    </div>
                    <label for="fakultas_id">Fakultas </label>
                    <div class="form-group">
                        <select name="fakultas_id" id="fakultas_id" class="form-select">
                            <option value="">-- Pilih Semester --</option>
                            @foreach ($fakultas as $fl)
                                <option value="{{ $fl->id }}">{{ $fl->nama_fakultas }}</option>
                            @endforeach
                        </select>
                    </div>
                </div>

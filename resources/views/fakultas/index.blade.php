...
@push('script')
    <script>
        $(document).ready(function () {
            ...
            $('#add').click(function () {
                $('#modal-title').html('Tambah Data Fakultas');
                $('#modal').modal('show');
            });
            ...
            $.ajax({
                url: "/fakultas/"+$(this).data('id')+"/edit",
                type: 'GET',
                success: function(result) {
                    $('#id').val(result.id);
                    $('#nama_fakultas').val(result.nama_fakultas);
                    $('#modal-title').html('Edit Data Fakultas');
                    $('#modal').modal('show');
                }
            });

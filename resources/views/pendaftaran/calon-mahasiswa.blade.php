                                ...
                                @else
                                    <div class="card-body">
                                        <form id="form">
                                            ...
                                            <div class="divider divider-left mt-5">
                                                <div class="divider-text">
                                                    <h5>Pembayaran Pendaftaran</h5>
                                                </div>
                                            </div>
                                            <span>Silahkan lakukan pembayaran Biaya Pendaftaran melalui transfer Bank BCA a/n Sekolah Tinggi Agama Islam Nahdlatul Ulama Pacitan</span>
                                            <div class="alert alert-light-secondary color-secondary mt-2">
                                                <div class="row">
                                                    <div class="col-md-3">
                                                        <img id="logo-bca" src="{{ asset('dist') }}/assets/compiled/png/bca.png" alt="Logo">
                                                    </div>
                                                    <div class="col-md-8">
                                                        <h3 class="mt-5">No. Rekening : 0181944884</h3>
                                                        <h3>a/n Sekolah Tinggi Agama Islam Nahdlatul Ulama Pacitan</h3>
                                                    </div>
                                                </div>
                                                <hr>
                                                <h5>Biaya Pendaftaran Calon Mahasiswa sejumlah Rp. 100.000,-</h5>
                                            </div>
                                            <div class="row mt-5">
                                                <div class="col-md-4">

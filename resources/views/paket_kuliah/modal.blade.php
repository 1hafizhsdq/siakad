            ...
            <form id="form">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <input id="nama_paket" name="nama_paket" type="text" placeholder="Cth: Pendidikan Agama Islam Semester 1" class="form-control">
                    </div>
                    <label for="semester">Semester </label>
                    <div class="form-group">
                        <input id="semester" name="semester" type="text" onkeypress="return isNumber(event)" class="form-control">
                    </div>
                </div>

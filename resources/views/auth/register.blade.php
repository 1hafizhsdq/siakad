...
<div class="row h-100">
    <div class="col-lg-5 col-12">
        <div id="auth-left">
            <div class="auth-logo">
                <img id="img-logo" src="{{ asset('dist') }}/assets/compiled/png/logo.png" alt="Logo">
            </div>
            <h1 class="auth-title text-success">Registrasi</h1>
            <p class="auth-subtitle mb-5">Silahkan Melakukan Registrasi</p>
            ...
            <form method="POST" action="{{ route('register') }}">
                ...
                @enderror
                <div class="form-group position-relative has-icon-left mb-4">
                    <input type="text" class="form-control form-control-xl @error('nama') is-invalid @enderror" name="nama" value="{{ old('nama') }}" placeholder="Nama Lengkap">
                    <div class="form-control-icon">
                ...
                @enderror
                <div class="form-group position-relative has-icon-left mb-4">
                    <input type="text" class="form-control form-control-xl @error('telp') is-invalid @enderror" name="telp" value="{{ old('telp') }}" placeholder="Telpon (WA)" onkeypress="return isNumber(event)">
                    <div class="form-control-icon">
                ...
                <button type="submit" class="btn btn-success btn-block btn-lg shadow-lg mt-5">Register</button>
            </form>
            <div class="text-center mt-5 text-lg fs-4">
                <p class='text-gray-600'>Sudah memiliki akun? <a href="/login" class="font-bold text-success">Log
                        in</a>.</p>
            </div>
        </div>
    </div>

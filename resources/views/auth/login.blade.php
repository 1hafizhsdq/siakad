        ...
        <div class="row h-100">
            <div class="col-lg-5 col-12">
                <div id="auth-left">
                    ...
                    <h1 class="auth-title text-success">Login</h1>
                    ...
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="form-group position-relative has-icon-left mb-4">
                            <input type="text" class="form-control form-control-xl @error('email') is-invalid @enderror"
                                placeholder="Email / Telp / NIM / NIP" name="email"
                                value="{{ old('email') }}">
                        ...
                        <button class="btn btn-success btn-block btn-lg shadow-lg mt-5" type="submit">Log in</button>
                    </form>
                    <div class="text-center mt-5 text-lg fs-4">
                        <p class="text-gray-600">Belum memiliki akun? 
                            <a href="{{ route('register') }}" class="font-bold text-success">Register disini</a>.
                        </p>
                        <p>
                            @if(Route::has('password.request'))
                                <a class="font-bold text-success" href="{{ route('password.request') }}">Lupa
                                    password?</a>
                            @endif
                        </p>
                    </div>
            ...
            <div class="col-lg-7 d-none d-lg-block">
                <div id="auth-right">
                    {{-- <img src="{{ asset('dist') }}/assets/compiled/jpg/stainu.jpg" alt=""> --}}
                </div>
            </div>
        </div>
